...
namespace DAL
{
    ...
    public partial class AdventureWorksLT2012 : DbContext
    {
        ...
        [DbFunction("AdventureWorksLT2012", "ufnGetAllCategories")]
        public virtual IQueryable<ufnGetAllCategories_Result> ufnGetAllCategories()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetAllCategories_Result>("[AdventureWorksLT2012].[ufnGetAllCategories]()");
        }
    
        [DbFunction("AdventureWorksLT2012", "ufnGetCustomerInformation")]
        public virtual IQueryable<ufnGetCustomerInformation_Result> ufnGetCustomerInformation(Nullable<int> customerID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetCustomerInformation_Result>("[AdventureWorksLT2012].[ufnGetCustomerInformation](@CustomerID)", customerIDParameter);
        }
